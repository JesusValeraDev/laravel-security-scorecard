...
4. Add or update tests when a confirmed issue can regress silently.
...
6. Re-run the most relevant verification after each confirmed fix: targeted tests first, broader regression when the affected surface is large or risky.
