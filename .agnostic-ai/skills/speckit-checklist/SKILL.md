...
**Key Difference:** Wrong items test if the system works ("Does it do X?"); correct items test if the requirements are written correctly ("Is X clearly specified?").
